...
const Login: React.FC = () => {
    ...
    const handleGoogleLogin = async () => {
        ...
        setIsLoading(true);
        try {
            // Simulated Google Sign-In prompt or endpoint submission
            ...
            <div className="w-full max-w-md relative z-10 animate-slide-up">
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 hover:border-white/20 p-6 sm:p-8 rounded-2xl shadow-2xl transition-all duration-300">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="w-full bg-white hover:bg-gray-100 text-gray-800 font-bold text-xs uppercase tracking-wider py-3 px-4 rounded-xl flex items-center justify-center gap-3 shadow-md transition-all mb-6 border border-gray-200 hover:scale-[1.01] cursor-pointer"
                    >
